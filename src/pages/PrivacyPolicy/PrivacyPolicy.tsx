  ...
  return (
    <div className="privacy-page">
      <div className="privacy-hero">
        <h1>PRIVACY POLICY — SmoothLend</h1>
      ...
      <section className="privacy-section">
          <p>
          SmoothLend (“we”, “our”, “us”) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, store, share, and protect your information when you use our website (“Website”).
...
“Even if my number is registered under DND (Do Not Disturb), I agree to receive calls, SMS, emails, and WhatsApp messages from SmoothLend and its lending partners regarding my loan application.”
